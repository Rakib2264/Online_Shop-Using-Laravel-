                    ...
                    <div class="col-md-5">
                        <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner bg-light">
                                @if ($product->productmages)
                                    @foreach ($product->productmages as $key => $image)
                                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                            <img class="w-100 h-100" src="{{ asset('products/large/' . $image->image) }}"
                                                alt="Image">
                                        </div>
                                    @endforeach
                                @endif
                    ...
                    <div class="col-md-7">
                        <div class="bg-light right">
                            ...
                            <div class="d-flex mb-3">
                                ...
                                <div class="star-rating star-rating-product mt-2" title="">
                        ...
                        <div class="bg-light">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <form action="" method="post" id="productRatingForm"
                                ...
                                <div class="card product-card">
                                    ...
                                    <div class="card-body text-center mt-3">
                                        <a class="h6 link" href="javascript:void(0)"
                                            onclick="addToCart({{ $product->id }})">{{ $relatedProduct->title }}</a>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.status == false) {
                        ...
                        window.location = '{{ route('frontend.product_detail', $product->slug) }}'
