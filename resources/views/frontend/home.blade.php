        ...
        <div class="container">
          ...
          <a class="nav-link active" aria-current="page" href="index.php" title="Products">Home</a>
                        ...
                        @if (getCategory()->isNotEmpty())
                            @foreach (getCategory() as $categiry)
                                <li class="nav-item dropdown">
                                    <button class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        {{ $categiry->name }}
                                    </button>
                                    @if ($categiry->sub_category->isNotEmpty())
            ...
            <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('frontend') }}/images/carousel-1-m.jpg" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend') }}/images/carousel-1.jpg" />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('frontend') }}/images/carousel-2-m.jpg" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend') }}/images/carousel-2.jpg" />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('frontend') }}/images/carousel-3-m.jpg" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend') }}/images/carousel-3.jpg" />
                            <img src="{{ asset('frontend') }}/images/carousel-2.jpg" alt="" />
                        </picture>
                        ...
                        @foreach (getCategory() as $category)
                            <div class="col-lg-3">
                                <div class="cat-card">
                                    <div class="left">
                                        @if ($category != '')
                                            <img src="{{ asset('up/cat/' . $category->image) }}" alt="">
                                        @endif
