                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$subcategories->name}}" name="name" id="name" class="form-control"
                                                placeholder="Name">
                                                <p></p>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control">
                                                ...
                                                <option value="0" {{($subcategories->status == 0) ? 'selected' : ''}}>Inactive</option>
                                            </select>
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{$subcategories->slug}}" type="text" readonly name="slug" id="slug"
