        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('coupon.create') }}" class="btn btn-primary">New Category</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                            ...
                            @if ($discountCoupons->isNotEmpty())
                                @foreach ($discountCoupons as $discountCoupon)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($discountCoupon->type == 'parcent')
                                              {{$discountCoupon->discount_amount}}%
                                              @else
                                              ${{$discountCoupon->discount_amount}}
                                            @endif
                                        </td>
                                        <td>{{ $discountCoupon->max_uses }}</td>
                                        <td>{{ $discountCoupon->max_uses_user }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('category.edit', $discountCoupon->id) }}">
